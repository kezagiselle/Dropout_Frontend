  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm border-b border-gray-200 px-4 sm:px-6 py-3 sm:py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <h2 className="text-lg sm:text-xl font-bold text-gray-800">Academic Portal</h2>
            <h1 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 ml-20">HoD & Registrar Dashboard</h1>
          </div>
      ...
      <div className="flex flex-col lg:flex-row">
        {/* Sidebar */}
        <nav className="w-full lg:w-64 bg-white shadow-sm lg:min-h-screen p-4 order-2 lg:order-1">
        ...
        {/* Main Content */}
        <main className="flex-1 p-3 sm:p-4 order-1 lg:order-2">
          {activeView === 'dashboard' && (
            <>
              {/* Summary Cards */}
    ...
    <div>
          ...
          {activeView === 'communication' && (
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <p className="text-gray-600">Communication tools interface coming soon...</p>
            </div>
          )}
