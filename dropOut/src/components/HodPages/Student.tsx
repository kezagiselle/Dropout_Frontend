  ...
  return (
    <div className="w-full space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
        <div>
          <h1 className={`text-2xl lg:text-3xl font-bold transition-colors duration-200 ${
            theme === 'dark' ? 'text-white' : 'text-gray-900'
          }`}>
            Students Management
          </h1>
          <p className={`text-sm lg:text-base mt-1 transition-colors duration-200 ${
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
          ...
          <div className="relative flex-1 sm:flex-none sm:w-80">
            ...
            <input
              ...
              className={`w-full pl-10 pr-4 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200 ${
                theme === 'dark'
      ...
      <div className={`rounded-lg shadow-sm border p-4 lg:p-6 transition-colors duration-200 ${
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
          <h3 className={`text-sm lg:text-base font-medium transition-colors duration-200 ${
      ...
      <div className={`rounded-lg shadow-sm border transition-colors duration-200 ${
        ...
        {/* Table Header */}
        <div className={`px-4 lg:px-6 py-4 border-b transition-colors duration-200 ${
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className={`transition-colors duration-200 ${
              ...
              <tr>
                <th className={`px-4 lg:px-6 py-3 text-left text-xs font-medium uppercase tracking-wider transition-colors duration-200 ${
            ...
            <tbody className={`divide-y transition-colors duration-200 ${
              ...
              {students.map((student) => (
                <tr key={student.id} className={`hover:transition-colors duration-200 ${
                  ...
                  <td className="px-4 lg:px-6 py-4 whitespace-nowrap">
                    <span className={`inline-flex px-2.5 py-0.5 rounded-full text-xs font-medium border ${getRiskLevelColor(student.riskLevel)}`}>
                      {student.riskLevel}
                    </span>
                  </td>
                  <td className="px-4 lg:px-6 py-4 whitespace-nowrap">
