  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex">
        ...
        {/* Main Content - Removed max-w-7xl mx-auto to push content left */}
        <main className="flex-1 min-w-0 p-3 sm:p-4 lg:p-6">
            ...
            <div className="flex flex-col md:flex-row gap-3 sm:gap-4">
              ...
              <div className="relative">
                <select
                  ...
                  className="appearance-none bg-white border border-gray-300 rounded-lg px-3 py-2 sm:px-4 sm:py-2.5 pr-8 sm:pr-10 text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer w-full"
                >
          ...
          <div className="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-200">
            <div className="overflow-x-auto">
              <table className="w-full min-w-[640px]">
                <thead className="bg-gray-50 border-b border-gray-200">
                  <tr>
                    <th className="px-3 py-2.5 sm:px-4 sm:py-3 lg:px-6 lg:py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">
                      School Name
                    </th>
                    <th className="px-3 py-2.5 sm:px-4 sm:py-3 lg:px-6 lg:py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">
                      Region
                  ...
                  {filteredSchools.map((school) => (
                    <tr key={school.id} className="hover:bg-gray-50 transition-colors">
                      <td className="px-3 py-2.5 sm:px-4 sm:py-3 lg:px-6 lg:py-4">
                        <span className="text-blue-600 hover:text-blue-800 cursor-pointer font-medium text-xs sm:text-sm truncate block max-w-[150px] sm:max-w-none">
                          {school.name}
                        </span>
                      </td>
                      <td className="px-3 py-2.5 sm:px-4 sm:py-3 lg:px-6 lg:py-4 text-gray-700 text-xs sm:text-sm whitespace-nowrap">
                        {school.region}
                      </td>
                      <td className="px-3 py-2.5 sm:px-4 sm:py-3 lg:px-6 lg:py-4">
            ...
            {/* Pagination */}
            <div className="px-3 py-2.5 sm:px-4 sm:py-3 lg:px-6 lg:py-4 border-t border-gray-200 flex flex-col sm:flex-row items-center justify-between gap-3 bg-white">
              <div className="text-xs sm:text-sm text-gray-600 whitespace-nowrap">
                Showing 1 to {filteredSchools.length} of {schools.length} schools
              </div>
              <div className="flex items-center gap-1 sm:gap-2">
                <button className="px-2 py-1 sm:px-3 sm:py-1.5 border border-gray-300 rounded hover:bg-gray-50 flex items-center gap-1 text-gray-700 text-xs sm:text-sm whitespace-nowrap">
                  <ChevronLeft className="w-3 h-3 sm:w-4 sm:h-4" />
                  <span className="hidden sm:inline">Previous</span>
                  <span className="sm:hidden">Prev</span>
                </button>
                <button className="w-6 h-6 sm:w-8 sm:h-8 lg:w-9 lg:h-9 bg-orange-500 text-white rounded font-medium text-xs sm:text-sm flex items-center justify-center">
                  1
                </button>
                <button className="w-6 h-6 sm:w-8 sm:h-8 lg:w-9 lg:h-9 border border-gray-300 rounded hover:bg-gray-50 text-gray-700 text-xs sm:text-sm flex items-center justify-center">
                  2
                </button>
                <button className="w-6 h-6 sm:w-8 sm:h-8 lg:w-9 lg:h-9 border border-gray-300 rounded hover:bg-gray-50 text-gray-700 text-xs sm:text-sm flex items-center justify-center">
                  3
