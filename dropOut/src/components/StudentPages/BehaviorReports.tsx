...
const BehaviorReports: React.FC = () => {
  ...
  // Updated student-specific menu items with correct routes
  const menuItems = [
    { icon: SiGoogleclassroom, label: 'My Classes', path: '/student-class' },
    { icon: FileText, label: 'My Assignments', path: '/my-assignments' },
    { icon: TbReport, label: 'Behavior Reports', path: '/student/behavior-reports' }, // Updated
    { icon: IoMdSettings, label: 'Settings', path: '/student/settings' } // Updated
  ];
        ...
        `}>
          ...
          <nav className="p-3 sm:p-4 relative z-50 bg-white h-full">
            <button 
              ...
              onClick={() => handleNavigation('/student-dashboard', 'Dashboard')} // Updated to student-dashboard
            >
