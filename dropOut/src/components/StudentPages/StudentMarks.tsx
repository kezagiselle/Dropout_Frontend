...
const StudentMarks = () => {
  ...
  const { courseName, marks, studentName } = (location.state as LocationState) || {
          ...
          <div className="bg-white border-b border-gray-200 px-4 py-4 sm:px-6 lg:px-8 mb-6 rounded-lg shadow-sm">
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-gray-500 mt-1 text-sm sm:text-base">Student: {studentName}</p>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-sm overflow-hidden">
            <div className="px-4 py-5 sm:px-6 border-b border-gray-200">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Showing {filteredMarks.length} of {totalMarks} assessments
              </p>
            </div>
