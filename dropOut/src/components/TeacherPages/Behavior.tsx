          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-4 sm:mb-6">
              <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-2">
                ...
                <div className="flex flex-col xs:flex-row gap-2 w-full sm:w-auto">
                  <button 
                    className="bg-orange-500 hover:bg-orange-600 text-white px-3 sm:px-4 py-2 rounded-lg flex items-center gap-2 transition-colors justify-center text-sm sm:text-base w-full sm:w-auto"
                    onClick={handleLogNewReport}
                  >
                    <Plus className="w-4 h-4" />
                    Log New Report
                  </button>
                  <button className="bg-blue-400 hover:bg-blue-500 text-white px-3 sm:px-4 py-2 rounded-lg flex items-center gap-2 transition-colors justify-center text-sm sm:text-base w-full sm:w-auto">
            ...
            <div className="bg-white rounded-lg shadow-sm p-3 sm:p-4 mb-4 sm:mb-6">
              <div className="flex flex-col sm:flex-row sm:items-center gap-3 flex-wrap">
                ...
                <div className="grid grid-cols-1 xs:grid-cols-2 lg:flex gap-3 w-full sm:w-auto">
                  <div className="relative">
                    <select 
                      value={selectedStudent}
                      onChange={(e) => setSelectedStudent(e.target.value)}
                      className="appearance-none bg-white border border-gray-300 rounded-lg px-3 sm:px-4 py-2 pr-8 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 w-full"
                    >
                  ...
                  <input 
                    ...
                    className="border border-gray-300 rounded-lg px-3 sm:px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 w-full"
                  />
                </div>
                ...
                <div className="flex items-center gap-2 w-full sm:w-auto mt-2 sm:mt-0">
                  ...
                  <div className="relative flex-1 sm:flex-none">
                    <select 
                      ...
                      className="appearance-none bg-white border border-gray-300 rounded-lg px-3 sm:px-4 py-2 pr-8 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 w-full sm:w-auto"
                    >
            ...
            {/* Stats */}
            <div className="grid grid-cols-1 xs:grid-cols-3 gap-3 sm:gap-4 lg:gap-6 mb-4 sm:mb-6">
              <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 text-center">
                <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-blue-600 mb-1">24</div>
                <div className="text-sm text-gray-600">Commendations</div>
              </div>
              <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 text-center">
                <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-orange-500 mb-1">8</div>
                <div className="text-sm text-gray-600">Minor Incidents</div>
              </div>
              <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 text-center">
                <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-red-500 mb-1">3</div>
            ...
            {/* Reports List */}
            <div className="mb-4 sm:mb-6">
              <h2 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Recent Behavior Reports</h2>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4 text-xs sm:text-sm text-gray-600 mb-2 sm:mb-3">
                          <div className="flex items-center gap-1">
                            ...
                            <span className="truncate">{report.grade}</span>
                          </div>
                          <div className="flex items-center gap-1">
                            <svg className="w-3 h-3 sm:w-4 sm:h-4" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <p className="text-xs sm:text-sm text-gray-700 line-clamp-2 sm:line-clamp-3">{report.description}</p>
                      </div>
                    </div>
                  </div>
                ))}
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-1 sm:gap-2">
                <button className="px-2 sm:px-3 py-2 border border-gray-300 rounded-lg text-sm text-gray-600 hover:bg-gray-50 flex items-center gap-1">
                  <ChevronLeft className="w-3 h-3 sm:w-4 sm:h-4" />
                  <span className="hidden xs:inline">Previous</span>
                </button>
                <button className="px-2 sm:px-3 py-2 bg-orange-500 text-white rounded-lg text-sm font-medium">
                  1
                </button>
                <button className="px-2 sm:px-3 py-2 border border-gray-300 rounded-lg text-sm text-gray-600 hover:bg-gray-50 flex items-center gap-1">
